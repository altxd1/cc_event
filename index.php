...
// Get featured items for display
$featured_places = [];
$featured_food = [];
$featured_designs = [];

// You can add queries here to get featured items from database
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <?php else: ?>
                <a href="create_event.php" class="btn btn-primary" style="font-size: 1.2rem; padding: 1rem 2rem;">
