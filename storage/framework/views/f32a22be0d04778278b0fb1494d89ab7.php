        ...
        <div class="auth-buttons">
            <?php if(function_exists('isLoggedIn') && isLoggedIn()): ?>
                <?php if(function_exists('isAdmin') && isAdmin()): ?>
                    <a href="<?php echo e(url('/admin')); ?>" class="btn btn-primary">Admin Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-primary">My Dashboard</a>
                <?php endif; ?>
...
<section class="hero">
    <div class="container">
        ...
        <?php if(! (function_exists('isLoggedIn') && isLoggedIn())): ?>
            <a href="<?php echo e(url('/register')); ?>" class="btn btn-primary" style="font-size: 1.2rem; padding: 1rem 2rem;">
                Get Started <i class="fas fa-arrow-right"></i>
            </a>
        <?php else: ?>
            <a href="<?php echo e(route('events.create')); ?>" class="btn btn-primary" style="font-size: 1.2rem; padding: 1rem 2rem;">
...
</html><?php /**PATH C:\xampp\htdocs\evnt\myapp\resources\views/home.blade.php ENDPATH**/ ?>