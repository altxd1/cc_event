    ...
    <div class="container">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li><a href="manage_items.php?type=food" <?php echo $type == 'food' ? 'class="active"' : ''; ?>>
                    <i class="fas fa-utensils"></i> Food Items</a></li>
                <li><a href="manage_items.php?type=places" <?php echo $type == 'places' ? 'class="active"' : ''; ?>>
                    <i class="fas fa-map-marker-alt"></i> Event Places</a></li>
                <li><a href="manage_items.php?type=designs" <?php echo $type == 'designs' ? 'class="active"' : ''; ?>>
